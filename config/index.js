...
const ociConfig = require('./oci-config')
...
const OciVaultBackend = require('../lib/backends/oci-vault-backend')
...
const ociVaultBackend = new OciVaultBackend({
  clientFactory: ociConfig.vaultClient,
  logger
})
